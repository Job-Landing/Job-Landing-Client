...
import { Home, Dashboard, Profile, Management, Login, Signup, Error, PrivateRoute} from './pages';
import 'animate.css';
...
function App() {
  return (
    ...
    <Routes>
      ...
      <Route path="/jobupdate/:jobId" element={<PrivateRoute><Management /></PrivateRoute>} ></Route>
