            ...
            <div className='box_wrapper_bottom'>
                <div className='box_wrapper_top'>
                    <div className='box_wrapper1'>
                        {
                            path === 'profile' ? <FaceRoundedIcon className='icon'/> : path === 'joblist' ?
                                <FormatListBulletedRoundedIcon className='icon'/> : path === 'addjob' ?
                                    <AddTaskRoundedIcon className='icon'/> : <LiveTvIcon className='icon'/>
                        }
                    </div>
